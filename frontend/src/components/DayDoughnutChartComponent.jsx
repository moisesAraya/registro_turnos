...
const DayDoughnutChart = ({ year, area }) => {
        ...
        <div>
            {isLoading ? (
                ...
                <>
                    ...
                    <div style={{ width: '90%', maxWidth: '500px', height: 'auto', margin: 'auto', marginLeft: '320px' }}>
                        <Doughnut data={scans} options={options} />
                    </div>
                </>
            ) : (
...
export default DayDoughnutChart;